...
function prepareRelay(filenames) {
    ...
    var operations = filenames.map(function (filename) {
        ...
        var textContent = fs_1.default.readFileSync(filename, "utf8");
        ...
        if (operationAlias) {
            ...
            var absoluteFilename = path_1.default.resolve(currentDirectory, filename);
