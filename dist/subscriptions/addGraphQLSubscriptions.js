...
var ActionCableSubscriber_1 = __importDefault(require("./ActionCableSubscriber"));
var PusherSubscriber_1 = __importDefault(require("./PusherSubscriber"));
/**
...
function addGraphQLSubscriptions(networkInterface, options) {
    ...
    if (options.subscriber) {
        ...
        subscriber = new PusherSubscriber_1.default(options.pusher, networkInterface);
    }
    else {
